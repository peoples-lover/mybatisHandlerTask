...
public class MysqlUtilTable2XML {
    ...
    public static void printXMLForMap(TablesBean bean) {
        ...
        for(i =0;i<bean.getFieldList().size();i++) {
            ...
            if ("id".equals(obj.getField().toLowerCase()) ||"gmt_create".equals(obj.getField()) || "gmt_modify".equals(obj.getField())
        ...
        bf.append(TAB).append(TAB).append(TAB).append("gmt_modify").append("\n");
        bf.append(TAB).append(TAB).append(")values(").append("\n");
        for(i =0;i<bean.getFieldList().size();i++) {
            FieldBean obj = bean.getFieldList().get(i);
            if ("id".equals(obj.getField().toLowerCase()) ||"gmt_create".equals(obj.getField())
                    || "gmt_modify".equals(obj.getField()) || "is_delete".equals(obj.getField())) {
                continue;
            }
        ...
        for(i =0;i<bean.getFieldList().size()-1;i++) {
            FieldBean obj = bean.getFieldList().get(i);
            if ("id".equals(obj.getField().toLowerCase()) || "gmt_modify".equals(obj.getField())) {
                continue;
            }
        ...
        bf.append(TAB).append(TAB).append(",gmt_modify = now()").append("\n");
